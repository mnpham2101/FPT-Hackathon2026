...
Two processes, one image: the C++17 `ada_ecu` core and the Python detector subprocess, joined by argv, exit codes and R3 JSONL over stdout — [design decision D2](../documents/Design/MODULE-DESIGN/ADA-ECU/ada-ecu-design-decisions.md#d2--process-thread-and-mock-model).

## Design of record

- [doc/ada-ecu-hld.md](../documents/Design/MODULE-DESIGN/ADA-ECU/ada-ecu-hld.md) — the HLD, this folder's sole design authority.
