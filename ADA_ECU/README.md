...
- **Layout & build rules:** [node-code-layout.md](../.claude/rules/node-code-layout.md) — C++17 core + Python 3.11 detector subprocess, `docker build -t m1-ada-ecu:latest ADA_ECU/`.
