...
Superseded and point-in-time documents, kept for the record. **Nothing here is authoritative.** A document lands in this folder when it stops describing the current design but is still worth being able to read.
