...
- **Design authority:** [doc/scenario-player-hld.md](../documents/Design/MODULE-DESIGN/SCENARIO-PLAYER/scenario-player-hld.md) — every component, path, seam, configuration key and evidence line, with its [decision record](../documents/Design/MODULE-DESIGN/SCENARIO-PLAYER/scenario-player-design-decisions.md).
