...
Full mission, scope, contracts, and phase plan live in [CLAUDE.md](CLAUDE.md) and [milestone1_high_level_plan.md](documents/Plan-Proposal/milestone1_high_level_plan.md). Original goals and the deferred future-feature list are in [.claude/prompts/project_goals.md](.claude/prompts/project_goals.md).
