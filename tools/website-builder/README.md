...
```bash
pip install -r tools/website-builder/requirements.txt   # once
python tools/website-builder/build-pages.py             # from the repo root
python tools/website-builder/build-pages.py --clean     # drop stale pages first
python tools/website-builder/build-pages.py documents/Design/README.md   # just one
```
