...
window.KIS.SITE = {
  ...
  nodes: [
    ...
    { id: 'knowledge-base', parent: 'concepts', label: 'Knowledge Base', icon: 'knowledge-base',
      href: 'pages/knowledge-base.html', pos: [18, 10],
    ...
    { id: 'proposal-presentation', parent: 'proposal', label: 'Proposals', icon: 'proposal-presentation',
      href: 'pages/proposal-presentation.html', pos: [78, 20],
    ...
    { id: 'system-design', parent: 'design', label: 'System Design', icon: 'system-design',
      href: 'pages/system-design.html', pos: [18, 48],
    ...
    { id: 'module-design', parent: 'design', label: 'Module Design', icon: 'module-design',
      href: 'pages/module-design.html', pos: [14, 72],
    ...
    { id: 'article-style', parent: 'module-design', label: 'Article Style', icon: 'article-style',
      href: 'pages/article-style.html', pos: [25, 84],
