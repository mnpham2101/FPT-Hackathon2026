...
- [phase0-smoke-test-run.md](../../plans/doc/deprecated/phase0-smoke-test-run.md) · [baseline-connectivity-smoke-test.md](../../documents/Delivery/baseline-connectivity-smoke-test.md) · [netcheck.py](../../tools/netcheck/netcheck.py) — the smoke test is a one-way relay chain, not a handshake; `START_DELAY_S` is its only readiness mechanism; hop 3 unconfirmed (O4).
