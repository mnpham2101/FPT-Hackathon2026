...
- [phase5-ivi-hld.md](../IVI_ECU/doc/phase5-ivi-hld.md) · `R4Message.kt` · `build.gradle.kts` — R4 carries no timestamp; `WARNING_TIMEOUT_MS` is a local countdown; R3 timestamps parsed and unused.
