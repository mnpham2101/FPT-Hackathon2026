...
- [ada-ecu-hld.md](../ADA_ECU/doc/ada-ecu-hld.md) — the ADA design this analysis read: `TRACK_TIMEOUT_MS` as silence, `DETECTOR_FRAME_STRIDE` as decimation rather than a rate, and the unstated clock source that §6.2's ruling settles.
