...
- [video-source-for-r12.md](../ADA_ECU/doc/research_notes/video-source-for-r12.md) and [phase2-4-ada-ecu-hld.md](../ADA_ECU/doc/phase2-4-ada-ecu-hld.md) — the ADA-side source decision, the `FrameSource` seam (D6), and the deployment shape (D9).
