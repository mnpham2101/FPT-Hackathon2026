...
Plus the active plan [milestone1_high_level_plan.md](../../../documents/Plan/milestone1_high_level_plan.md) for the requirement's phase, phase objective, and phase acceptance criteria.
