...
- **`PLATFORMS` names exactly one platform** — the project requires single-platform `linux/arm64` images ([phase0-smoke-test-run.md § Standing requirement](../../../plans/doc/deprecated/phase0-smoke-test-run.md)); a multi-platform list is a defect to fix here, not at deploy time;
