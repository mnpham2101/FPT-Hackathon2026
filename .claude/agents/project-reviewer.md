...
- **Check placement and discipline as well as code** — node and test-equipment folders against [CLAUDE.md § Repository layout](../../CLAUDE.md), CI lanes against [ci-lane-placement.md](../rules/ci-lane-placement.md), commit tags against [task-planning-conventions.md](../rules/task-planning-conventions.md#commit-message-format). These land in the row they affect or in the conclusion's themes, never as new sections.
