...
- Phase content (objectives, tasks, tech stack, acceptance criteria) comes from the active plan doc, currently [milestone1_high_level_plan.md](../../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md), plus [[project-researcher]]'s enumerated requirements and [[project-architecture]]'s design/contracts.
