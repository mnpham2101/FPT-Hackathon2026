...
- **Reference documentation** — all four CLAUDE.md Document-authority documents in authority order, plus [milestone1_high_level_plan.md](../../documents/Plan/milestone1_high_level_plan.md) for the requirement's phase and acceptance criteria.
