...
| [project-reviewer](.claude/agents/project-reviewer.md) | Reviewing a delivered pull request or branch against the HLD, plan and requirements; the `reviews/` documents | Planning the fix, fixing the code, authoring design or requirements |
...
- [reviews/](reviews/) — one review document per pull request, `pr-<N>-<slug>-review.md`, committed on the branch it judges; format in [pull-request-review-format.md](.claude/rules/pull-request-review-format.md).
