...
- **[documents/Plan and Proposal/](documents/Plan%20and%20Proposal/)** — [milestone1_high_level_plan.md](documents/Plan%20and%20Proposal/milestone1_high_level_plan.md) is the **authority for milestone phase planning**: project-planner decomposes all tasks/subtasks from its phases (the `Y` segment of task IDs) and phase acceptance criteria. Its abridged presentation is [m1-proposal-deck.md](presentation/m1-proposal-deck.md); on any conflict the plan wins.
