...
- **Code: one top-level folder per R5 node** — [Scenario_Player/](Scenario_Player/) (bench, R11) · [V2X_ECU/](V2X_ECU/) (R1, R7–R9; R10 deferred to a future milestone) · [ADA_ECU/](ADA_ECU/) (R3, R12–R15) · [IVI_ECU/](IVI_ECU/) (R4, R16–R17). Languages, build artifacts, and the self-contained-folder rules: [.claude/rules/node-code-layout.md](.claude/rules/node-code-layout.md); per-node deploy steps: [requirements/car-sky-guide/](requirements/car-sky-guide/) — within it, [ivi-hmi-walkthrough.md](requirements/car-sky-guide/ivi-hmi-walkthrough.md) is **authoritative for the IVI APK's build, export, install, launch and verification**; follow it rather than improvising a route.
