# The case for cooperative awareness

## The reality
- 81 percent of crash scenarios are due to NLOS (non-line-of-sight).
...
- Each needs to see a vehicle that radar, camera, and lidar cannot.

![Scenario and warning type: rear-end (forward collision, emergency electronic brake light), lane-change (blind spot, do not pass), and intersection (blind intersection) warnings, sourced from GAO analysis of Crash Avoidance Metrics Partnership information](assets/risk-type.jpg)
