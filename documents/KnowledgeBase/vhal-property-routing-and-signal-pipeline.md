...
0x1A 0x04 0x82 0x41 0xC0 0x00 0x00
         │
         ▼  (Stage 1-2: Gateway MCU & Native VHAL AIDL)
[AIDL Struct: VehiclePropValue]
  ...
  value     = FloatValues[ 24.0f ]
         │
         ▼  (Stage 3-4: CarService Binder IPC & Permission Check)
[CarPropertyValue<Float>]
  ...
  value      = 24.0f
         │
         ▼  (Stage 5: Kotlin App Callback)
Log.d("VHAL", "Zone 1 Set: 24.0°C")
```
        ...
        override fun onChangeEvent(value: CarPropertyValue<*>) {
            ...
            when (value.propertyId) {
                VehiclePropertyIds.HVAC_TEMPERATURE_SET -> {
                    ...
                    Log.d(TAG, "[VHAL RX] Zone $areaId Temp Set: $tempC°C (ts=${value.timestamp})")
                }
