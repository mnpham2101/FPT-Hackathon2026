...
| [milestone1_high_level_plan.md](../../Plan%20and%20Proposal/milestone1_high_level_plan.md) | §5's Phase 1 acceptance, which this node's evidence closes (§12); §4's R13 gate values, which the derived `object.distance` feeds |
