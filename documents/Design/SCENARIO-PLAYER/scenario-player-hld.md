...
| [milestone1_high_level_plan.md](../../Plan-Proposal/milestone1_high_level_plan.md) | §4's R13 gate values, which the committed scenarios are authored against (D3); Phase 1's bench acceptance |
