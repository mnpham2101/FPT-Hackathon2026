...
The scenario values pair with the R13 gate constants that [milestone1_high_level_plan.md §4](../../Plan-Proposal/milestone1_high_level_plan.md#track-admission-gate-r13) fixes. The pairing is a property of the data, so a gate change is answered by editing the YAML, never by editing the model.
