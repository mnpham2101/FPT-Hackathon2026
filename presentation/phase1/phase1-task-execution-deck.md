...
Sources: [phase1_tasks.md](../../plans/phase1_tasks.md) · [phase1-comms-run.md](../../plans/doc/deprecated/phase1-comms-run.md) · design documents for the [V2X ECU](../../documents/Design/V2X-ECU/v2x-ecu-hld.md) and the [bench](../../documents/Design/SCENARIO-PLAYER/scenario-player-hld.md)
