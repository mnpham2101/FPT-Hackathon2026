...
Sources: [phase1_tasks.md](../../plans/phase1_tasks.md) · [phase1-comms-run.md](../../plans/doc/phase1-comms-run.md) · design documents for the [V2X ECU](../../documents/Design/V2X-ECU/v2x-ecu-hld.md) and the [bench](../../documents/Design/SCENARIO-PLAYER/scenario-player-hld.md)
...
| ------------------ | ---------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------------- |
| **Track**          | a workstream spanning whole phases, executed by different people concurrently      | [milestone1_high_level_plan.md](../../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md)        | the comms track = Phase 1 |
