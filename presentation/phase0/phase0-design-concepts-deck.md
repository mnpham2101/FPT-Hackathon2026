...
description: Design deck — the terminology, the five-node blueprint, the four frozen contracts and their locations, the protocol stack and its libraries, the state in which Phase 0 left the bench and V2X nodes, and the smoke test that closed the phase
...
Sources: [phase0_tasks.md](../../plans/phase0_tasks.md) · [milestone1.md](../../plans/milestone1.md) · [phase0-contract-freeze-hld.md](../../deprecated/phase0-contract-freeze-hld.md) · [contracts/](../../contracts/)
...
5. **The bench and the V2X node** — the state Phase 0 left them in
6. **The smoke test** — its conclusions, and where the full report is held
...
# The exchange as Phase 0 executed it
...
- **The per-node call flows are already drafted** in each node's `doc/` folder. They are Phase 1 material and belong to the Phase 1 deck.
