...
<div class="cols" style="align-items:center; gap:30px; margin:6px 0 10px;">
<div style="flex:0 0 auto;"><img src="../assets/m1-report-contribution-donut.svg" alt="Contribution as a share of total weighted effort" style="height:340px; width:auto; border-radius:10px; box-shadow:0 6px 22px rgba(15,20,60,.16);"></div>
