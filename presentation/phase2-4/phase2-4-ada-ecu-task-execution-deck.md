...
Sources: [phase2_tasks.md](../../plans/phase2_tasks.md) · [phase3_tasks.md](../../plans/phase3_tasks.md) · [phase4_tasks.md](../../plans/phase4_tasks.md) · [milestone1.md](../../plans/milestone1.md) · the run records in [plans/doc/](../../plans/doc/)
...
| ---- | ---------- | ------------ | ------------ |
| **Track** | a workstream spanning whole phases, run by different people at once | [milestone1.md](../../plans/milestone1.md) | this node is one track: phase 2, then 3 and 4 |
