...
> **Authority & context:**
>
> - **Phase content:** [milestone1_high_level_plan.md § Phase 5](../documents/Plan-Proposal/milestone1_high_level_plan.md#phase-5--ivi-hmi-mock-driven-r16-r17--display-track-parallel-from-the-start) — its five acceptance criteria are the phase output.
...
**Output (phase acceptance — the five criteria of [milestone1_high_level_plan.md § Phase 5](../documents/Plan-Proposal/milestone1_high_level_plan.md#phase-5--ivi-hmi-mock-driven-r16-r17--display-track-parallel-from-the-start)):**
...
>
> **This group closes no Phase 5 acceptance criterion.** It produces the whole-topology evidence Phase 6's R19 convergence run starts from ([milestone1_high_level_plan.md § Phase 6](../documents/Plan-Proposal/milestone1_high_level_plan.md#phase-6--convergence-real-data-end-to-end-r18-r19--r10-moved-to-the-future-plan)).
...
Every Phase 5 acceptance criterion in [milestone1_high_level_plan.md](../documents/Plan-Proposal/milestone1_high_level_plan.md#phase-5--ivi-hmi-mock-driven-r16-r17--display-track-parallel-from-the-start) maps to at least one subtask.
...
- **The ego video clip in the Display Area** — deferred by the report's §4 decision record and itemized in [milestone1_high_level_plan.md §6](../documents/Plan-Proposal/milestone1_high_level_plan.md#6-deferred-to-later-milestones); no subtask implements any part of it, including a `DisplayMode`, a media dependency or a `video` pin.
