...
**Acceptance:** all four KPIs recorded with their measured values; this closes the R12 detection-log box and the CPU-only/offline-pace box at host level (`5.3.6.2` repeats KPI 3 on the deployed node).
