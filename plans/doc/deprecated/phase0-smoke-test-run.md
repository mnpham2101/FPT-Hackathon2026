...
Evidence log for task group 0.8 ([phase0_tasks.md](../../phase0_tasks.md)), executing [baseline-connectivity-smoke-test.md](../../../documents/Delivery/Test-Guides/baseline-connectivity-smoke-test.md). Steps are recorded as they complete; pass criteria C1–C5 are the note's.
