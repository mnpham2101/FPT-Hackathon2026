...
Its decisions D1–D4 are cited by the §2 reading list of [scenario-player-hld.md](../../../documents/Design/SCENARIO-PLAYER/scenario-player-hld.md), [v2x-ecu-hld.md](../../../documents/Design/V2X-ECU/v2x-ecu-hld.md) and [ada-ecu-hld.md](../../../documents/Design/ADA-ECU/ada-ecu-hld.md), which is why the file is retained rather than deleted. Folding those decisions into the node HLDs that depend on them is [[project-architecture]]'s call.
