...
> **Authority & context:**
> - **Phase content:** [milestone1_high_level_plan.md § Phase 2](../documents/Plan-Proposal/milestone1_high_level_plan.md#phase-2--ada-scaffolding-store--state-machine-no-detector-r3-r13) — its six acceptance checkboxes are the phase output.
...
**Phase 3 and Phase 4 relative to this phase.** Both run in parallel after Phase 2 ([milestone1_high_level_plan.md §3](../documents/Plan-Proposal/milestone1_high_level_plan.md#3-development-plan--order-of-implementation)), and neither needs the other. Phase 4 needs groups 2.2–2.6 (store, admission, CRA seam, main loop) plus `5.2.7.1`; Phase 3 needs only the frozen `detector/contracts/tracked_object.py` from Phase 0 and the `DETECTOR_CMD` contract from `12.2.6.2`.
