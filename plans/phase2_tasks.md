...
> **Authority & context:**
> - **Phase content:** [milestone1_high_level_plan.md § Phase 2](../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md#phase-2--ada-scaffolding-store--state-machine-no-detector-r3-r13) — its six acceptance checkboxes are the phase output.
...
> - **Run timing:** [m1-run-timing-and-event-triggering.md](../requirements/m1-run-timing-and-event-triggering.md) — §6.2's clock-domain ruling, which `2.2.3.1` and `13.2.4.3` implement; §6.1's env values and §6.6's R22 choreography, which `13.2.2.1` loads (HLD [D10](../documents/Design/ADA-ECU/ada-ecu-design-decisions.md#d10--clock-domains-and-stimulus-paced-against-clock_monotonic), [D11](../documents/Design/ADA-ECU/ada-ecu-design-decisions.md#d11--r22-run-choreography-the-run-origin-the-paced-clip-and-the-risk-band-pair)).
...
- **Timestamps, per [HLD §10.2](../documents/Design/ADA-ECU/ada-ecu-hld.md#102-r3--the-object-model-of-the-store-owned) and [m1-run-timing-and-event-triggering.md §6.2](../requirements/m1-run-timing-and-event-triggering.md):**
...
**Phase 3 and Phase 4 relative to this phase.** Both run in parallel after Phase 2 ([milestone1_high_level_plan.md §3](../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md#3-development-plan--order-of-implementation)), and neither needs the other. Phase 4 needs groups 2.2–2.6 (store, admission, CRA seam, main loop) plus `5.2.7.1`; Phase 3 needs only the frozen `detector/contracts/tracked_object.py` from Phase 0 and the `DETECTOR_CMD` contract from `12.2.6.2`.
...
*Phase 2 = 9 task groups, 26 subtasks — 25 *AI* (2 docs-only), 1 *Human*. Nothing started. Decomposed from [ada-ecu-hld.md](../documents/Design/ADA-ECU/ada-ecu-hld.md), [video-source-for-r12.md](../documents/KnowledgeBase/video-source-for-r12.md) and [milestone1_high_level_plan.md § Phase 2](../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md#phase-2--ada-scaffolding-store--state-machine-no-detector-r3-r13).*
