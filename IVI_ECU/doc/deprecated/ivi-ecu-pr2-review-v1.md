...
> **Judged against:** [ivi-ecu-hld.md](../../../documents/Design/MODULE-DESIGN/IVI-ECU/ivi-ecu-hld.md) and [ivi-ecu-design-decisions.md](../../../documents/Design/MODULE-DESIGN/IVI-ECU/ivi-ecu-design-decisions.md) · [m1-cooperative-awareness.md §2](../../../documents/Requirements/m1-cooperative-awareness.md) · [phase5_minh_tasks.md](../../../plans/phase5_minh_tasks.md), the authoritative Phase 5 plan · the frozen schemas [r4-ada-ivi.schema.json](../../contracts/r4-ada-ivi.schema.json) and [r3-tracked-object.schema.json](../../contracts/r3-tracked-object.schema.json)
...
Rows are the components the IVI HLD defines ([§3](../../../documents/Design/MODULE-DESIGN/IVI-ECU/ivi-ecu-hld.md#3-the-component-architecture), [§6](../../../documents/Design/MODULE-DESIGN/IVI-ECU/ivi-ecu-hld.md#6-internal-components)), each at the path [§4](../../../documents/Design/MODULE-DESIGN/IVI-ECU/ivi-ecu-hld.md#4-folder-structure) designates. A component the branch never created is a row at 0% rather than an omission — that is what makes this a completion measure. Rows marked *inherited* came from the merge base and were not touched by this PR; they are scored for **where the branch leaves them**, since this PR's work was supposed to reach them.
...
- **Document placement.** `requirements/blueprint-2node-task51-test-guide.md` is a deploy procedure, and [CLAUDE.md § Repository layout](../../../CLAUDE.md) puts those in `requirements/car-sky-guide/` as a `*-walkthrough.md` authored by `project-researcher`. `plans/doc/session-summary-2026-07-30.md` is a progress record, which the documentation rules exclude from `doc/`.
