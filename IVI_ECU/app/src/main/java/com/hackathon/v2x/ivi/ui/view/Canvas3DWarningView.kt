...
private fun DrawScope.drawSidePanel(
    ...
    val cMainLbl = textMeasurer.measure(AnnotatedString("C — HIDDEN"), StyleMain.copy(color = GhostCColor.copy(alpha = 0.85f)))
    ...
    // --- Risk colour key ---
    legendY += 20f
    val riskHdrLbl = textMeasurer.measure(AnnotatedString("RISK — HIDDEN C GLOW COLOUR"), StyleDim)
