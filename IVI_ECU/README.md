...
- **Layout & build rules:** [CLAUDE.md § Repository layout](../CLAUDE.md) — Kotlin / Jetpack Compose, APK via `./gradlew assembleDebug` from this folder.
- **Plan:** Phase 5 of [milestone1_high_level_plan.md](../documents/Plan/milestone1_high_level_plan.md), decomposed in [phase5_minh_tasks.md](../plans/phase5_minh_tasks.md); wired to real ADA output in Phase 6.
