...
- **Plan:** Phase 5 of [milestone1_high_level_plan.md](../documents/Plan-Proposal/milestone1_high_level_plan.md), decomposed in [phase5_minh_tasks.md](../plans/phase5_minh_tasks.md); wired to real ADA output in Phase 6.
