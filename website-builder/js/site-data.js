/* KIS site — the site graph, transcribed from the concept page (Designer.png).
   ...
   The four direct children of 'kis' sit beside the WarningRing instead:
   `ringSide` ('top'/'left'/'right') + optional `ringAlign` (0-1 fraction
   along that side) place them a fixed pixel gap outside the ring's own
   measured box (mindmap.js), so they stay correctly placed if the ring
   is ever resized — no `pos` needed for these four. */
...
window.KIS.SITE = {
  ...
  nodes: [
    ...
    { id: 'concepts', parent: 'kis', label: 'Concepts', icon: 'concepts',
      href: 'pages/concepts.html', ringSide: 'top',
    ...
    { id: 'proposal', parent: 'kis', label: 'Proposal', icon: 'proposal',
      href: 'pages/proposal.html', ringSide: 'right', ringAlign: 0.28,
    ...
    { id: 'design', parent: 'kis', label: 'Design', icon: 'design',
      href: 'pages/design.html', ringSide: 'left',
    ...
    { id: 'module-design', parent: 'design', label: 'Module Design', icon: 'module-design',
      href: 'pages/module-design.html', pos: [17, 70],
    ...
    { id: 'presentation-style', parent: 'module-design', label: 'Presentation Style', icon: 'presentation-style',
      href: 'pages/presentation-style.html', pos: [13, 87],
    ...
    { id: 'article-style', parent: 'module-design', label: 'Article Style', icon: 'article-style',
      href: 'pages/article-style.html', pos: [31, 83],
    ...
    { id: 'delivery', parent: 'kis', label: 'Delivery', icon: 'delivery',
      href: 'pages/delivery.html', ringSide: 'right', ringAlign: 0.74,
