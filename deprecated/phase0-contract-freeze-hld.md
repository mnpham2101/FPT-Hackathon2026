...
> High-level design for [milestone1_high_level_plan.md § Phase 0](../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md#phase-0--freeze-the-contracts-r1r6), per [hld-content-and-commit-format.md](../.claude/rules/hld-content-and-commit-format.md). Requirement definitions, field tables, and tech stacks live in [m1-cooperative-awareness.md](../requirements/m1-cooperative-awareness.md) §2 Contracts and §3 — referenced, never restated. Call-flow source: [phase0-contract-freeze-call-flow.puml](phase0-contract-freeze-call-flow.puml).
>
...
| [Phase 0 acceptance](../documents/Plan%20and%20Proposal/milestone1_high_level_plan.md#phase-0--freeze-the-contracts-r1r6) | Closed by |
|---|---|
